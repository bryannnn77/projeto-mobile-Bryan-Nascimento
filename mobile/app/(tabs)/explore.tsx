import { StyleSheet, Image, TextInput, View, ScrollView, KeyboardAvoidingView, Platform, TouchableWithoutFeedback, Keyboard, Alert } from 'react-native';
...
export default function TabTwoScreen() {
  ...
  const openai = new OpenAI({
    apiKey: "", //adicionar chave api aqui professor
  });
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      const botMessage = { 
        text: completion.choices[0]?.message?.content || 'Não entendi...', 
        user: 'bot' 
      };
